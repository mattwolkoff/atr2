  ...
  $scope.Layers = [
      {
        ...
        layers:[
          ...
          {name:'TMAS WIM Stations',selector:'tmas_w', loaded:false, visible:false, type:'d3',style:{cursor:'pointer',stroke:'purple','stroke-width':'15px',fill:'purple'},mouseover:{info:[{name:"Station ID: ",prop:"station_id"},{name:"Functional Class Code: ",prop:"func_class_code"},{name:"Method of Classification: ",prop:"method_of_vehicle_class"},{name:"Method of Truck Weighing: ",prop:"method_of_truck_weighing"},{name:"Type of Sensor: ",prop:"type_of_sensor"}],style:{cursor:'pointer',stroke:'black', stroke:'red','stroke-width':'2px'}}},
          {name:'TMAS Class Stations',selector:'tmas_c', loaded:false, visible:false, type:'d3',style:{cursor:'pointer',stroke:'#0027FF','stroke-width':'5px',fill:'#0027FF'},mouseover:{info:[{name:"Station ID: ",prop:"station_id"},{name:"Functional Class Code: ",prop:"func_class_code"},{name:"Method of Classification: ",prop:"method_of_vehicle_class"},{name:"Method of Truck Weighing: ",prop:"method_of_truck_weighing"},{name:"Type of Sensor: ",prop:"type_of_sensor"}],style:{cursor:'pointer',stroke:'black', stroke:'red','stroke-width':'2px'}}},
          {name:'TMAS Volume Stations',selector:'tmas_v', loaded:false, visible:false, type:'d3',style:{cursor:'pointer',stroke:'#00FF0E','stroke-width':'0px',fill:'#00FF0E'},mouseover:{info:[{name:"Station ID: ",prop:"station_id"},{name:"Functional Class Code: ",prop:"func_class_code"},{name:"Method of Classification: ",prop:"method_of_vehicle_class"},{name:"Method of Truck Weighing: ",prop:"method_of_truck_weighing"},{name:"Type of Sensor: ",prop:"type_of_sensor"}],style:{cursor:'pointer',stroke:'black', stroke:'red','stroke-width':'2px'}}},
